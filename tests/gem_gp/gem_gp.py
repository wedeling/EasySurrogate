...
# Get the simulation data for the model

# datadict = load_csv_file() # if only csv file
# campaign.store_data_to_hdf5(data, file_path='gem_data_625.hdf5') # if only csv file
