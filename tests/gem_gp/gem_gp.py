...
feat_train, targ_train, feat_test, targ_test = campaign.surrogate.feat_eng.\
    get_training_data(features, target, test_frac=1.0)
...
analysis.get_regression_error(feat_test, targ_test)  #, x_test_inds=np.arange(len(target)))
...
# OBSERVATION: forward prediction devirges and yields negative value of fluxes
