...
qoi_targ=2.E+6 #TODO copy/read from production run result csv
...
campaign.surrogate.train_sequentially(n_iter=20, target=qoi_targ)
campaign.save_state(file_path='model_val_seq_15112022.pickle')
