...
data_frame_red = campaign.load_hdf5_data(
    file_path='../samples/gray_scott_online_M1_tau_infty2.hdf5')
# load the data from the wrong model
data_frame_wrong = campaign.load_hdf5_data(
    file_path='../samples/gray_scott_training_stationary_epsilon.hdf5')
