...
def reduced_sgs():
    """
    An EasySurrogate Reduced surrogate, executed in a separate file and linked to the
    ...
    while instance.reuse_instance():
        ...
        V_hat_1_re = msg.data['V_hat_1_re'].array
        V_hat_1_im = msg.data['V_hat_1_im'].array
        u_hat_re = msg.data['u_hat_re'].array
        u_hat_im = msg.data['u_hat_im'].array
        v_hat_re = msg.data['v_hat_re'].array
        v_hat_im = msg.data['v_hat_im'].array
        Q_ref = msg.data['Q_ref'].array
        Q_model = msg.data['Q_model'].array
        ...
        #time loop, just one loop in this case
