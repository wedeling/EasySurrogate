...
import numpy as np
from easysurrogate.methods.reduced_surrogate import train
...
def reduced_sgs():
    ...
    while instance.reuse_instance():
        ...
        while t_cur + dt <= msg.timestamp + t_max:
            ...
            reduced_dict_u = train([V_hat_1, u_hat], Q_ref[0:N_Q], Q_model[0:N_Q])
            reduced_dict_v = train([V_hat_1, v_hat], Q_ref[N_Q:], Q_model[N_Q:])
        ...
        #O_F
        instance.send('sgs', Message(t_cur, t_cur + dt, 
