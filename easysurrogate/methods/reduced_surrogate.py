...
"""
===============================================================================
CLASS FOR A REDUCED SURROGATE FOR SPECTRAL MODEL
------------------------------------------------------------------------------
Author: W. Edeling
...
class Reduced_Surrogate(Campaign):
    ...
    def train(self, V, qois_ref, qois_model):
        ...
        if not type(qois_ref) == np.ndarray or not type(qois_model) == np.ndarray:
        ...
        V_hat = np.zeros([self.n_qoi, self.n_model_1d, self.n_model]) + 0.0j
    ...
    def reduced_r(self, V_hat, dQ):
        ...
        inner_prods = self.inner_products(V_hat, self.n_model_1d)
