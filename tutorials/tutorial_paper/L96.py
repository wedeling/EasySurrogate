...
class L96:
    ...
    def step(self, X_n, f_nm1, **kwargs):
        """
        Integrate the L96 system in time. If `r_n` is specified as a key
        word argument, kwargs['r_n'] is used as a subgrid-scale term. Otherwise
        the small-scale equation is solved to compute the subgrid scale term.
